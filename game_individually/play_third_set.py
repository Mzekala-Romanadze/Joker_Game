...
def play_third_set(original_players_order, perfect_match_scores):
    third_set_scores, perfect_match_player_scores = play_one_set(original_players_order, perfect_match_scores)
    ...
    if perfect_match is None:
        ...
        third_set_scores = final_set_scores_table(players_and_third_set_scores, perfect_match)
        return third_set_scores
